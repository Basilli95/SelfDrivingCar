...
const traffic=[
    ...
    new Car(road.getLaneCenter(1),-1300,30,50,"DUMMY",2.2),
    new Car(road.getLaneCenter(0),-1500,30,50,"DUMMY",2),
    new Car(road.getLaneCenter(2),-1500,30,50,"DUMMY",1.5),
];
...
function animate(time){
    ...
    //allows the road to keep the same form when the window is resized 
    carCanvas.height=window.innerHeight;
    networkCanvas.height=window.innerHeight;

    //creates a camera to follow the car on the y axis
    carCtx.save();
